...
arrivals <- sightings |> 
  map(possibly(\(s) weib_percentile_ci(s$Year, 250, 0.05, 100, parallelize = "snow", ncpus = 8)))
...
pres_hfds <- hfds |> mutate(region_cell = rasterized) |> 
  ...
  # Adding Mycoplasma presence from Montana to shift things westward (Dhondt et al. 2006)
