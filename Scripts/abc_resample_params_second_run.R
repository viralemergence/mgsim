...
param_dists <- lapply(colnames(demo_params_selected)[-c(25, 31, 48, 49)], function(param) {
  ...
  disc <- ifelse(param %in% c("density_max", "abundance_threshold"),
                 TRUE,
                 FALSE)
...
# Make 10,000 resamples based on results
{
  ...
  dt_lhs_run3 <- data.table(
    dispersal_p_juv = rbetat(
      n = 10000,
      range = quantile(demo_params_selected[["dispersal_p_juv"]], probs = c(0.05, 0.95)),
    ...
    dispersal_p_adult = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["dispersal_p_adult"]], probs = c(0.05, 0.95)),
    ...
    dispersal_r_juv = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["dispersal_r_juv"]], probs = c(0.05, 0.95)),
    ...
    dispersal_r_adult = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["dispersal_r_adult"]], probs = c(0.05, 0.95)),
    ...
    dispersal_source_n_k_cutoff = rbetat(
      n = 10000,
      range = quantile(demo_params_selected[["dispersal_source_n_k_cutoff"]], probs = c(0.05, 0.95)),
    ...
    dispersal_source_n_k_threshold = rbetat(
      n = 10000,
      range = quantile(demo_params_selected[["dispersal_source_n_k_threshold"]], probs = c(0.05, 0.95)),
      shape1 = param_dists$dispersal_source_n_k_threshold$Output$beta$estimate[1],
      shape2 = param_dists$dispersal_source_n_k_threshold$Output$beta$estimate[2]
    ),
    dispersal_target_n_k_cutoff = rbetat(
      n = 10000,
      range = quantile(demo_params_selected[["dispersal_target_n_k_cutoff"]], probs = c(0.05, 0.95)),
      shape1 = param_dists$dispersal_target_n_k_cutoff$Output$beta$estimate[1],
      shape2 = param_dists$dispersal_target_n_k_cutoff$Output$beta$estimate[2]
    ),
    dispersal_target_n_k_threshold = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["dispersal_target_n_k_threshold"]], probs = c(0.05, 0.95)),
      min = param_dists$dispersal_target_n_k_threshold$Output$triangular$estimate[1],
      max = param_dists$dispersal_target_n_k_threshold$Output$triangular$estimate[2],
      mode = param_dists$dispersal_target_n_k_threshold$Output$triangular$estimate[3]
    ),
    ...
    initial_release = round(
      rtrianglet(
        n = 10000,
        range = quantile(demo_params_selected[["initial_release"]], probs = c(0.05, 0.95)),
    ...
    fecundity = round(
      rtrianglet(
        n = 10000,
        range = quantile(demo_params_selected[["fecundity"]], probs = c(0.05, 0.95)),
    ...
    infected_t1 = round(
      rtrianglet(
        n = 10000,
        range = quantile(demo_params_selected[["infected_t1"]], probs = c(0.05, 0.95)),
    ...
    beta_Sa_winter = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["beta_Sa_winter"]], probs = c(0.05, 0.95)),
    ...
    beta_Sa_summer = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["beta_Sa_summer"]], probs = c(0.05, 0.95)),
    ...
    beta_I2_modifier = rbetat(
      n = 10000,
      range = quantile(demo_params_selected[["beta_I2_modifier"]], probs = c(0.05, 0.95)),
    ...
    mortality_Sj_winter = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_Sj_winter"]], probs = c(0.05, 0.95)),
    ...
    mortality_Sa_winter = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_Sa_winter"]], probs = c(0.05, 0.95)),
    ...
    mortality_Sj_summer = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_Sj_summer"]], probs = c(0.05, 0.95)),
    ...
    mortality_I1j_summer = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_I1j_summer"]], probs = c(0.05, 0.95)),
      min = param_dists$mortality_I1j_summer$Output$triangular$estimate[1],
      max = param_dists$mortality_I1j_summer$Output$triangular$estimate[2],
      mode = param_dists$mortality_I1j_summer$Output$triangular$estimate[3]
    ),
    mortality_I1j_winter = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_I1j_winter"]], probs = c(0.05, 0.95)),
    ...
    mortality_I1a_summer = rlnormt(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_I1a_summer"]], probs = c(0.05, 0.95)),
    ...
    mortality_I1a_winter = rlnormt(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_I1a_winter"]], probs = c(0.05, 0.95)),
    ...
    mortality_I2_modifier = rbetat(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_I2_modifier"]], probs = c(0.05, 0.95)),
    ...
    mortality_I2j_summer = rbetat(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_I2j_summer"]], probs = c(0.05, 0.95)),
      shape1 = param_dists$mortality_I2j_summer$Output$beta$estimate[1],
      shape2 = param_dists$mortality_I2j_summer$Output$beta$estimate[2]
    ),
    mortality_I2j_winter = rbetat(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_I2j_winter"]], probs = c(0.05, 0.95)),
    ...
    mortality_I2a_winter = rbetat(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_I2a_winter"]], probs = c(0.05, 0.95)),
    ...
    mortality_I2a_summer = rbetat(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_I2a_summer"]], probs = c(0.05, 0.95)),
    ...
    mortality_Rj_summer = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_Rj_summer"]], probs = c(0.05, 0.95)),
    ...
    mortality_Rj_winter = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_Rj_winter"]], probs = c(0.05, 0.95)),
    ...
    mortality_Ra_winter = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["mortality_Ra_winter"]], probs = c(0.05, 0.95)),
    ...
    beta_Sj_winter = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["beta_Sj_winter"]], probs = c(0.05, 0.95)),
      min = param_dists$beta_Sj_winter$Output$triangular$estimate[1],
      max = param_dists$beta_Sj_winter$Output$triangular$estimate[2],
      mode = param_dists$beta_Sj_winter$Output$triangular$estimate[3]
    ),
    ...
    beta_Ra_winter = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["beta_Ra_winter"]], probs = c(0.05, 0.95)),
    ...
    beta_Rj_winter = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["beta_Rj_winter"]], probs = c(0.05, 0.95)),
    ...
    beta_Ra_summer = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["beta_Ra_summer"]], probs = c(0.05, 0.95)),
    ...
    beta_Rj_summer = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["beta_Rj_summer"]], probs = c(0.05, 0.95)),
    ...
    recovery_I1j_summer = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["recovery_I1j_summer"]], probs = c(0.05, 0.95)),
    ...
    recovery_I1a_summer = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["recovery_I1a_summer"]], probs = c(0.05, 0.95)),
      min = param_dists$recovery_I1a_summer$Output$triangular$estimate[1],
      max = param_dists$recovery_I1a_summer$Output$triangular$estimate[2],
      mode = param_dists$recovery_I1a_summer$Output$triangular$estimate[3]
    ),
    recovery_I2j_summer = rlnormt(
      n = 10000,
      range = quantile(demo_params_selected[["recovery_I2j_summer"]], probs = c(0.05, 0.95)),
      meanlog = param_dists$recovery_I2j_summer$Output$lnorm$estimate[1],
      sdlog = param_dists$recovery_I2j_summer$Output$lnorm$estimate[2],
    ),
    recovery_I2a_summer = rlnormt(
      n = 10000,
      range = quantile(demo_params_selected[["recovery_I2a_summer"]], probs = c(0.05, 0.95)),
      meanlog = param_dists$recovery_I2a_summer$Output$lnorm$estimate[1],
      sdlog = param_dists$recovery_I2a_summer$Output$lnorm$estimate[2],
    ),
    recovery_I1j_winter = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["recovery_I1j_winter"]], probs = c(0.05, 0.95)),
    ...
    recovery_I1a_winter = rtrianglet(
      n = 10000,
      range = quantile(demo_params_selected[["recovery_I1a_winter"]], probs = c(0.05, 0.95)),
    ...
    recovery_I2j_winter = rlnormt(
      n = 10000,
      range = quantile(demo_params_selected[["recovery_I2j_winter"]], probs = c(0.05, 0.95)),
      meanlog = param_dists$recovery_I2j_winter$Output$lnorm$estimate[1],
      sdlog = param_dists$recovery_I2j_winter$Output$lnorm$estimate[2],
    ),
    recovery_I2a_winter = rlnormt(
      n = 10000,
      range = quantile(demo_params_selected[["recovery_I2a_winter"]], probs = c(0.05, 0.95)),
      meanlog = param_dists$recovery_I2a_winter$Output$lnorm$estimate[1],
      sdlog = param_dists$recovery_I2a_winter$Output$lnorm$estimate[2],
    )
  )
}
...
lapply(colnames(dt_lhs_run3), function(param) {
  ...
  plot(
    ...
    xlim = range(orig),
    freq = FALSE,
    ylim = range(p1$density, p2$density),
    main = param,
    xlab = NA,
    ylab = NA
  )  # first histogram
...
fwrite(dt_lhs_run3,
       here("Data/Input/sample_data_round2.csv"))
