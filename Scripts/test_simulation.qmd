...
adult_dispersal_gen <- DispersalGenerator$new(
  ...
  inputs = c("dispersal_p_adult",
             "dispersal_r_adult",
             "dispersal_source_n_k_cutoff", "dispersal_source_n_k_threshold",
             "dispersal_target_n_k_threshold", "dispersal_target_n_k_cutoff"),
...
adult_dispersal_data <- adult_dispersal_gen$generate(
  input_values = list(
    ...
    dispersal_source_n_k_cutoff = 0.25, 
    dispersal_source_n_k_threshold = 0.75,
    dispersal_target_n_k_cutoff = 0.8, 
    dispersal_target_n_k_threshold = 0.2
  )
) |> _$dispersal_data
...
lhs_generator$set_uniform_parameter("abundance_threshold", lower = 0, upper = 25)
lhs_generator$set_uniform_parameter("initial_release", lower = 5, upper = 50)
