...
# Make 10,000 resamples based on results
{
  ...
  dt_lhs_run2 <- data.table(
    ...
    dispersal_target_n_k_threshold = rbetat(
      n = 10000,
      range = quantile(
        demo_params_selected[["dispersal_target_n_k_threshold"]],
        probs = c(0.05, 0.95)
      ),
      shape1 = param_dists$dispersal_target_n_k_threshold$Output$beta$estimate[
        1
      ],
      shape2 = param_dists$dispersal_target_n_k_threshold$Output$beta$estimate[
        2
      ]
    ),
    ...
    beta_Sj_winter = rgammat(
      n = 10000,
      range = quantile(
        demo_params_selected[["beta_Sj_winter"]],
        probs = c(0.05, 0.95)
      ),
      shape = param_dists$beta_Sj_winter$Output$gamma$estimate[1],
      rate = param_dists$beta_Sj_winter$Output$gamma$estimate[2]
    ),
    ...
    recovery_I2a_summer = rbetat(
      n = 10000,
      range = quantile(
        demo_params_selected[["recovery_I2a_summer"]],
        probs = c(0.05, 0.95)
      ),
      shape1 = param_dists$recovery_I2a_summer$Output$beta$estimate[1],
      shape2 = param_dists$recovery_I2a_summer$Output$beta$estimate[2]
    ),
    ...
    recovery_I2j_winter = rbetat(
      n = 10000,
      range = quantile(
        demo_params_selected[["recovery_I2j_winter"]],
        probs = c(0.05, 0.95)
      ),
      shape1 = param_dists$recovery_I2j_winter$Output$beta$estimate[1],
      shape2 = param_dists$recovery_I2j_winter$Output$beta$estimate[2]
    ),
    recovery_I2a_winter = rbetat(
      n = 10000,
      range = quantile(
        demo_params_selected[["recovery_I2a_winter"]],
        probs = c(0.05, 0.95)
      ),
      shape1 = param_dists$recovery_I2a_winter$Output$beta$estimate[1],
      shape2 = param_dists$recovery_I2a_winter$Output$beta$estimate[2]
    )
  )
}
...
write.csv(
  dt_lhs_run2,
  here("Data_minimal/Input/sample_data_round2b.csv"),
  row.names = FALSE
)
