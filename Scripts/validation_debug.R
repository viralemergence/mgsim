...
results_dir <- system("cd /glade/derecho/scratch/pilowskyj/Round1; ls -f", intern = T) |>
...
presence_list <- results_dir[dc] |>
  map(\(f) paste0("/glade/derecho/scratch/pilowskyj/Round1/", f)) |>
...
write_csv(presabs, "/glade/u/home/pilowskyj/mgsim/Data_minimal/Validation/presabs.csv")
