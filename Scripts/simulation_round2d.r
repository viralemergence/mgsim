...
library(here)
library(doParallel)
i_am("mgsim/Scripts/simulation_round2d.r")
data_dir <- here("mgsim/Data_minimal/Input")
results_dir <- "/glade/work/pilowskyj/Round2d" # production
...
write_csv(
  ...
  file.path("/glade/work/pilowskyj/incomplete_sims_round2d.csv")
)
results_dir <- "/glade/work/pilowskyj/Round2d"
...
sample_data <- read_csv(file.path(data_dir, "sample_data_round2d.csv")) |>
  mutate(
